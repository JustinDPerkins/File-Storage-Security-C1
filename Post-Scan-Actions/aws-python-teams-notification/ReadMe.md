# Cloud One File Storage Security Post Scan Action - Teams

After a malicious scan event occurs, this example Lambda function sends a notification in Microsoft Teams.
...
To test that the application was deployed properly, you'll need to generate a malware detection using the [eicar test file](https://secure.eicar.org/eicar.com "A file used for testing anti-malware scanners."), and then check the Microsoft Teams notification to make sure the event was sent successfully.
...
2. **Upload the eicar file to the ScanningBucket**
    ...
    - Using the AWS console
        ...
        4. Check your Microsoft Teams channel for the event.
