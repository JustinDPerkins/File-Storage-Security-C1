...
$c1api = "add your cloud one api key"
$c1region = "add your c1 account region example: us-1"
$scannerstack = "enter name of scanner stack"
$sqsurl = "enter scanner stack sqs url"

$templateUrl = "https://aws-workshop-c1as-cft-templates.s3.amazonaws.com/fss-automate-v2.yml"
...
$c1apikey = "ParameterKey=C1API,ParameterValue=$c1api"
$sqsurlvalue = "ParameterKey=SQSURL,ParameterValue=$sqsurl"
$scannerstackvalue = "ParameterKey=StackName,ParameterValue=$scannerstack"
$c1endpoint = "ParameterKey=C1RegionEndpoint,ParameterValue=$c1region"
	...
	if (Is-Region-Enabled($region)) {
		...
		if ($lastExitCode -eq 0) {
			...
			aws cloudformation update-stack `
				...
				--region $region `
				--parameters $c1apikey $sqsurlvalue $scannerstackvalue $c1endpoint `
